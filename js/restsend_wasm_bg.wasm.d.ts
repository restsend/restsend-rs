...
export function client_getLatestConversations(a: number, b: number, c: number): number;
...
export function wasm_bindgen__convert__closures__invoke0_mut__hb85fa63649e5d279(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h11fc800670cef2ef(a: number, b: number, c: number): void;
