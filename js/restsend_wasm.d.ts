...
export class Client {
   ...
   * * `topicId` - topic id
   */
  markConversationUnread(topicId: string): Promise<void>;
  /**
   * Set conversation read by topicId
   * #Arguments
   * * `topicId` - topic id
...
export interface InitOutput {
  ...
  readonly client_markConversationUnread: (a: number, b: number, c: number) => any;
  ...
  readonly client_set_onpingfailed: (a: number, b: any) => void;
