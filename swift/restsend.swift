        ...
        try!  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_sync_chat_logs(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterOptionInt64.lower(lastSeq),FfiConverterUInt32.lower(limit),FfiConverterCallbackInterfaceSyncChatLogsCallback.lower(callback),FfiConverterOptionBool.lower(ensureConversationLastVersion)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_void,
            completeFunc: ffi_restsend_sdk_rust_future_complete_void,
        ...
        try!  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_sync_conversations(
                    self.uniffiClonePointer(),
                    FfiConverterOptionString.lower(updatedAt),FfiConverterUInt32.lower(limit),FfiConverterBool.lower(syncLogs),FfiConverterOptionUInt32.lower(syncLogsLimit),FfiConverterOptionUInt32.lower(syncLogsMaxCount),FfiConverterOptionString.lower(lastRemovedAt),FfiConverterCallbackInterfaceSyncConversationsCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_void,
            completeFunc: ffi_restsend_sdk_rust_future_complete_void,
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_restsend_sdk_checksum_method_callback_on_conversation_removed() != 1629) {
        return InitializationResult.apiChecksumMismatch
    }
